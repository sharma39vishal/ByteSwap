...
async function addquestion() {
  try {
    ...
    await axios.post("http://localhost:5000/discuss/adddiscussion",question,{withCredentials: true})
      ...
      <div className="askQuestion-design-container">
        ...
        <div className="askQuestion-left-container">
          ...
          <h1 style={{textAlign:"end"}}>
            <button className='add-query-button' onClick={()=>{addquestion()}}>Add Question</button>
          </h1>
        </div>
