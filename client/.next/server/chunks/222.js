...
function Header() {
    ...
    const logout = async ()=>{
        await axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.get("https://byteswap-f4y5.onrender.com/auth/logout").then(()=>{
...
const proxy = (0,module_proxy.createProxy)(String.raw`D:\ByteSwap\client\src\app\universal\header.js`)
...
const providers_proxy = (0,module_proxy.createProxy)(String.raw`D:\ByteSwap\client\src\app\providers.js`)
