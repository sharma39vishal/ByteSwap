...
passport.use(
  ...
  router.get("/google/callback", passport.authenticate("google", { failureRedirect: "http://localhost:5000/login" }),
    function (req, res) {
      res.redirect("http://localhost:5000/auth/isgoogleauthenticated");
    }
  );
